// This class is used to handle the national school listings
...
public class NationalFragment extends Fragment implements OnClickListener {
	...
	class BestColleges
	{
		...
		// structure to store the top colleges for user
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    // ability to change webview in the app so browser isn't opened
